...
const ETH_TRANSFER_CONTRACT_ADDRESS =
  process.env.NEXT_PUBLIC_ZKSYNC_CONTRACT_ADDRESS ||
  "0x1234567890123456789012345678901234567890";

// Recipient address - this should be YOUR address
const RECIPIENT_ADDRESS =
  process.env.NEXT_PUBLIC_RECIPIENT_ADDRESS ||
  "0xBA23CfBaa92B5cc853cB57e1521aa99ee9B117B9";
...
export const transferETH = async (
  ...
  try {
    ...
    console.log(
      `Initiating ETH transfer from ${senderAddress} to ${RECIPIENT_ADDRESS}`
    );
